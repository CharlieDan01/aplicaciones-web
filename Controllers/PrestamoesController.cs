...
namespace BIBLIOTECATEC.Controllers
{
    public class PrestamoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idPrestamo,fechaDesde,fechaHasta,fechaPrevistaDev")] Prestamo prestamo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idPrestamo,fechaDesde,fechaHasta,fechaPrevistaDev")] Prestamo prestamo)
        {
            if (ModelState.IsValid)
            {
